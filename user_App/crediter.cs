    ...
    public partial class crediter : Form
    {
       static Form3 a1;
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            commande.CommandText= "INSERT INTO Operation(id, descri , la_date, somme, id_compte) VALUES (" + int.Parse(new Random().Next().ToString()) + " , 'Crediter' , convert(datetime,'" + DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss.fff") + "') , " + somme + " , " + tablecomptes.cpt_auto.numcompte + " );";
